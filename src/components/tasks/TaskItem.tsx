        ...
        >
          <TaskTopRow>
            <TaskTopLeft>
              ...
              <TaskName done={task.done} style={{ fontSize: "16px" }}>
                {textHighlighter(task.name)}
              </TaskName>
            </TaskTopLeft>

            <TaskActionsContainer style={{ marginLeft: "auto", flexShrink: 0 }}>
              <TaskSideMeta>
                {task.recurrence &&
              ...
              <MockupStatusWrap onClick={handleToggleDone}>
                <MockupStatusLabel done={task.done}>
          ...
          {task.description && (
            <TaskDescriptionBox done={task.done}>
          ...
          {(task.pinned ||
            ...
            <TaskMetaRow
              translate="yes"
              style={{ marginTop: task.description ? "10px" : "8px", width: "100%" }}
            >
